...
?>
	...
	<div class="wrap">
		...
		<p>You may find that multiple Personal Access Token or APP ID configurations are required for your website. Create as many as you need!</p>
		<?php settings_errors(); ?>
...
function airpress_admin_cx_tab($key, $config)
{
	...
	$defaults = array(
		...
		"fresh"  => "fresh",
		"debug"	=> 0,
		"log"	=> $uploads["basedir"] . "/airpress-" . (substr(bin2hex(random_bytes(ceil(16 / 2))), 0, 16) ). ".log",
		"log_max_size"	=> 3072
	);
